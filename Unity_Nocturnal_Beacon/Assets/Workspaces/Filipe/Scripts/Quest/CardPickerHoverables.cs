...
public class CardPickerHoverables : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public void SetData(int i, Card assignedCard)
    {
        card = assignedCard;
        index = i;
        _efficiencyText.gameObject.SetActive(false);
